...
const HeroSection = () => {
  return <section id="home" className="min-h-screen flex items-center justify-center relative animated-noise-bg overflow-hidden">
      ...
      <img 
        src={heroBg}
        alt=""
        className="absolute inset-0 w-full h-full object-cover object-[center_20%] opacity-50 grayscale brightness-75 pointer-events-none scale-110"
      />
        ...
        <div className="text-center max-w-5xl mx-auto pt-20">
          ...
          delay: 0.2
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-none">
              <span className="text-gradient text-7xl">CHANDRASHEKHAR</span>
            </h1>
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-none">
          ...
          duration: 0.8,
          delay: 0.4
        }} className="text-primary font-mono text-lg md:text-xl mb-8">First-Year CST Student 🎓</motion.p>
          ...
          delay: 0.8
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
            ...
            <a href="mailto:your@email.com" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
